...
# Ogilvie_bronchial_norm <- read.table("/Users/matthieu/ownCloud/Thèse/Systems Biology/Transcriptomic studies/Transcriptomic Analyses/Analyse Ogilvie/Data/normalised/Ogilvie_clean_bronchial_normalised_counts_2022_01_24.txt",
#                                  sep = "\t",
#                                  header = T)
# 
# res_df <- read.table("~/ownCloud/Thèse/Systems Biology/Transcriptomic studies/Transcriptomic Analyses/Analyse Ogilvie/DE_Analysis/bronchial/Ogilvie_bronchial_differential_expression_analysis_limma_2022_01_24.txt",
#                          sep = "\t",
#                          header = T)
# 
# res_df <- merge(res_df,
...
#   
#   data_gene <- Ogilvie_bronchial_norm[affy_id,]
...
#             file = "~/ownCloud/Thèse/Systems Biology/Transcriptomic studies/Transcriptomic Analyses//Analyse Ogilvie/DE_Analysis/bronchial/Ogilvie_bronchial_DEG_limma_unique_HGNC_2022_02_09.csv",
#             sep = "\t",
#             row.names = F)

res_df_HGNC_final <- read.table("~/ownCloud/Thèse/Systems Biology/Transcriptomic studies/Transcriptomic Analyses//Analyse Ogilvie/DE_Analysis/bronchial/Ogilvie_bronchial_DEG_limma_unique_HGNC_2022_02_09.csv",
                                sep = "\t",
                                header = T)
...
save(fgseaRes,
     file = "~/ownCloud/Thèse/Systems Biology/Transcriptomic studies/Transcriptomic Analyses/Analyse Ogilvie/GSEA/Ogilvie_bronchial_fgsea_report_dorothea_pathways_2022_09_07.RData")
